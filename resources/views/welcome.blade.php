    ...
    <div class="container">
        ...
        <div class="navbar-left">
            ...
            <a class="navbar-brand" href="../index.html">
                <h1 class="h4" style="color: #fff">#BLOGIFY.</h1>
{{--                <img class="logo-dark" src="{{asset('img/blogify.png')}}" alt="logo">--}}
{{--                <img class="logo-light" src="{{asset('img/blogify.png')}}" alt="logo">--}}
            </a>
        </div>
        ...
        <a class="btn btn-xs btn-round btn-success" href="{{route('login')}}"><i class="fas fa-sign-in-alt"></i> Se Connecter</a>
    </div>
</nav><!-- /.navbar -->
...
<script src="{{asset('js/scipts.js')}}"></script>
